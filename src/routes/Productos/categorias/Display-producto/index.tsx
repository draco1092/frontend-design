  ...
  return (
    <> 
      ...
      <div class="container mx-auto px-4 py-8">
        <div class="-mx-4 flex flex-wrap items-start mask-b mask-b-from-95%">

          <div class="w-full px-4 mb-6 md:w-1/2 md:mb-0">
            <div class="rounded bg-violet-600/45 p-4">
              <Carusel />
            </div>
          </div>

          <div class="w-full px-4 md:w-1/2 mask-b-from-95%">
            <div class="rounded bg-fuchsia-200/80 p-4">
              ...
              <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:space-x-4">
                <button class="flex items-center justify-center gap-2 rounded-md bg-indigo-600 px-6 py-2 text-white hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none">
                  <svg
                ...
                <button class="flex items-center justify-center gap-2 rounded-md bg-gray-200 px-6 py-2 text-gray-800 hover:bg-gray-300 focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:outline-none">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
