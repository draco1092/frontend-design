...
export default component$(() => {
  ...
  return (
    ...
    <img
      ...
      />      <section>
<br />
    <h1 class="flex mx-auto px-1.5 w-fit box-border border-b-2 max-w-fit text-9xl text-center rounded border-dotted border-purple-900 bg-purple-950/2">{TituloPagina}</h1>
    <br />
          <h1 class="text-6xl text-center "> Categorias y Generos</h1>
          <Category />

        </section>
        

<h1 class="flex mx-auto px-1.5 w-fit box-border border-2 max-w-fit border-[#110818] text-6xl bg-[#201229]">lista de juegos </h1>
